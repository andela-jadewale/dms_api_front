...
module.exports = React.createClass({
  getInitialState: function (e) {
    ...
    if(!this.props.data) {
      return {lastName: '', firstName: '', email: '',
        username: '', role: '', oldpassword: '', newpassword: '',
         repassword: '' }
    }
    else {
      ...
      ,email: this.props.data.email, username: this.props.data.username,
       role: this.props.data.role, oldpassword: '', newpassword: '',
         repassword: ''  }
    }
  },
  ...
  password: function (e) {
    Names.password = e.target.value;
    this.setState({oldpassword: Names.password});
  },
  newPassword: function (e) {
    Names.newPassword = e.target.value;
    this.setState({newpassword: Names.newPassword});
  },
  rePassword: function (e) {
    Names.rePassword = e.target.value;
    this.setState({repassword: Names.newPassword});
  },
  render: function () {
    return (
      <div>
